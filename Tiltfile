...
### Redis ###
k8s_yaml("./infra/development/k8s/cache/redis-deployment.yaml")
...
k8s_resource(
    "api-gateway",
    port_forwards=8081,
    resource_deps=["api-gateway-compile", "rabbitmq", "redis"],
    labels="services",
)
### End of API Gateway ###
### Trip Service ###
...
k8s_resource(
    "trip-service",
    resource_deps=["trip-service-compile", "rabbitmq", "redis"],
    labels="services",
)
...
k8s_resource(
    "driver-service",
    resource_deps=["driver-service-compile", "rabbitmq", "redis"],
    labels="services",
)
...
k8s_resource(
    "payment-service",
    resource_deps=["payment-service-compile", "rabbitmq", "redis"],
    labels="services",
)
...
k8s_resource("grafana", port_forwards="3001:3001", resource_deps=["prometheus"], labels="tooling")
### End of Grafana ###
